...
class Game:
    ...
    def train(self, n, m, pars):
        ...
        while True:
            ...
            # 拆分數據
            state_old1 = state_old[:11]
            state_old2 = state_old[11:]

            # 使用fit_transform函数进行归一化
            state_old1 = scaler.fit_transform(state_old1.reshape(1, -1))
            state_old2 = scaler.fit_transform(state_old2.reshape(1, -1))

            # 扁平化數據
            state_old1 = state_old1.flatten()
            state_old2 = state_old2.flatten()
            ...
            # 拆分數據
            state_new1 = state_new[:11]
            state_new2 = state_new[11:]

            # 使用fit_transform函数进行归一化
            state_new1 = scaler.fit_transform(state_new1.reshape(1, -1))
            state_new2 = scaler.fit_transform(state_new2.reshape(1, -1))

            # 扁平化數據
            state_new1 = state_new1.flatten()
            state_new2 = state_new2.flatten()
